...
func Test(t *testing.T) {
	s, err := newVMessServer("test", "127.0.0.1", 8877, map[string]string{
		"id":       "937a376b-1723-40de-9815-3bcee70cc8b8",
		"method":   common.SecurityType_name[common.SecurityType_CHACHA20_POLY1305],
		"protocol": "ws",
		"path":     "/ray",
	}, nil)
	if err != nil {
	...
	sc, err := s.Dial(context.Background(), "tcp", new(Request), conn.DefaultDial)
	if err != nil {
		panic(err)
	}
	...
	//for {
	resp, err := http.ReadResponse(bufio.NewReader(sc), new(http.Request))
	if err != nil {
		panic(err)
	}
...
func (*Request) Domain() string {
	return "www.baidu.com"
}
func (*Request) IP() net.IP {
	return nil
}
...
//		Security: SecurityType_CHACHA20_POLY1305,
//	})
//	if err != nil {
//		panic(err)
//	}
